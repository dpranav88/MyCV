...
\cvitem{Data Science}{Feature Extraction, Machine Learning, Soft and Evolutionary Computing}
...
\cvitem{\textsc{Python}}{NumPy, SciPy, pandas, matplotlib, OpenCV, scikit-learn, NLTK, Keras, TensorFlow (Learning)}
...
\item Provided innovative solution for 9DoF based heading angle correction under slowly varying magnetic field. The solution is approved by RBEI IP department to file a \textbf{patent}. 
...
\cvitem{1:}{\textbf{Machine Learning} by Andrew Ng, Stanford University on Coursera,\newline{} (https://www.coursera.org/account/accomplishments/verify/JBRXBMHC86RY)}
...
\cvitem{Email}{josephrayan.pradeep@in.bosch.com }
