...
\cvitem{Signals}{Digital Signal Analysis and Processing (Motion Sensors, Biomedical and Audio Signal Processing, Basic Image Processing), Sensor Fusion (IMU)}
...
\cvitem{\textsc{Python}}{Basic of NumPy, SciPy, pandas, matplotlib, OpenCV, scikit-learn, Keras, TensorFlow}
\cvitem{C/C++}{Basic coding with openCV and DSP libraries}
...
\begin{itemize}
\item 9DoF based heading angle error reduction under slowly varying magnetic field. The solution is approved by RBEI IP department to file a \textbf{patent}.
\item Temperature compensated gyroscope bias estimation.(Submitted to RBEI IP Dept.)  
\item FlipCam and FastFlash gestures detection with only accelerometer sensor.(Submitted to RBEI IP Dept.)   
\end{itemize}
