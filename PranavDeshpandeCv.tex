...
\cventry{Sept 2021--Present}{Software Engineer}{Tektronix India Pvt. Ltd.}{Bengaluru}{}{Serving as a Signal Processing Algorithm Developer for PCIe team.}


\cventry{Sept 2017--Sept2021}{Associate Research Engineer}{Brigosha Technologies Pvt. Ltd.}{Bengaluru}{}{Serving as an Algorithm Developer at client location, i.e. \texttt{Robert Bosch Engineering and Business Solutions Pvt. Ltd. (RBEI), Coimbatore.}
...
\begin{itemize}
\item 9DoF based heading angle error reduction under slowly varying magnetic field. (Approved by RBEI IP department to file a \textbf{patent}.)
\item Temperature compensated gyroscope bias estimation.(Submitted to RBEI IP Dept.)  
\item FlipCam and FastFlash gestures detection with only accelerometer sensor. (Approved by RBEI IP department to file a \textbf{patent}.) 
\item Laptop Gesture and state detection with only accelerometer sensor. (Approved by RBEI IP department to file a \textbf{patent}.)   
\end{itemize}
...
\item Developed PoC for facial landmark based speech detection from video stream.
\end{itemize}}
%------------------------------------------------
