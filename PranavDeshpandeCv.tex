...
\cvitem{Signals}{Biomedical and Audio Signal Processing, Image Processing, Sensor Fusion}
...
\cvitem{\textsc{Python}}{NumPy, SciPy, pandas, matplotlib, \textbf{OpenCV}, \textbf{scikit-learn}, NLTK, Keras, TensorFlow (Learning)}
...
\cvitem{Office}{Git, \LaTeX, OpenOffice, scrum practices, Basic user level proficiency with Ubuntu and Microsoft Windows.}
...
\cventry{Sept 2017--Present}{Associate Research Engineer}{Brigosha Technologies Pvt. Ltd.}{Bengaluru}{}{Serving as an Algorithm Developer at client location, i.e. \texttt{Robert Bosch Engineering and Business Solutions Pvt. Ltd. (RBEI), Coimbatore.}
\center{\textsc{Key Result Area:}}
Algorithm development for Sensor Fusion Library
\begin{itemize}
\item Designed signal pre-processing modules, viz. offset removal and noise filtering for accelerometer, gyroscope and pressure sensors.
\item Specified signal and noise characteristics for different applications, viz. cars, drones and robots.
\item Done fine tuning of sensor fusion algorithms such as Kalman filters, Mahony filters.
\item Done Linear Regression Analysis for temperature compensation of gyroscope sensor offsets. 
...
\item Provided innovative solution for 9DoF based heading angle correction under slowly varying magnetic field. The solution was approved by department and pending for further approvals to file a patent. 
\item Developed harsh acceleration and sudden braking detection with only Accelerometer sensor for driving quality assessment. 
...
\item Developed MLP-based Neural Network model in scikiti-learn for predicting health category using features extracted from Tongue and Face images.
...
\cvitem{Machine Learning}{by Andrew Ng, Stanford University on Coursera,\newline{} (https://www.coursera.org/account/accomplishments/verify/JBRXBMHC86RY)}

%\cvitem{Learn Python: The Complete Python Automation Course!}{on Udemy,\newline{} (https://www.udemy.com/certificate/UC-25GBXWUQ/)}

%\cvitem{2018}{\textbf{Fundamentals of Parallelism on Intel Architecture} by Intel on Coursera, (Complete by July 2018)}

\cvitem{Introduction to Parallel Programming using GPGPU and CUDA}{on Udemy,\newline{} (https://www.udemy.com/certificate/UC-76HISUU8/)}
...
\cvitem{1}{\textbf{Pranav S. Deshpande} and M. S. Manikandan, ``Improving Accuracy of Glottal Closure Instant Detection Methods in Nonstationary Noise", in \emph{Proc. IEEE Int. Conf. on Signal Processing and Integrated Networks (SPIN-2015)}, Feb. 2015}
...
\cvlistdoubleitem{Surya Namaskar}{Playing Guitar and Harmonium}
...
\subsection{\textbf{1. Pradeep Joseph Rayan}}
\cvitem{Designation}{Senior Software Developer,Robert Bosch Engineering and Business Solutions Pvt. Ltd., Coimbatore}
\cvitem{Email}{pradeep@in.bosch.com }
\cvitem{Address}{EAC2, RBEI, CHIL-SEZ, Keeranatham Village, Coimbatore, Tamil Nadu 641035}
\subsection{\textbf{2. Dr. M. Sabarimalai Manikandan}}
