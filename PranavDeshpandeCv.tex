...
\cvitem{Signals}{Biomedical and Audio Signal Processing, Image Processing, Motion Sensor Fusion}
...
\cventry{2017--Present}{Associate Research Engineer}{\textsc{Brigosha Technologies}}{Bengaluru}{}{Since last \textbf{1 year}, serving as an Algorithm Developer at \textbf{Robert Bosch Engineering and Business Solutions Pvt. Ltd. (RBEI), Coimbatore} which is one of the client location.
\newline{}\newline{}
\begin{large}
\textbf{Projects Handled:}
\end{large}
\begin{enumerate}
\item \textbf{Motion Sensor Fusion Library} 
\begin{itemize}
...
\end{large}
\begin{enumerate}
\item \textbf{Multi-modal signal based Health Analysis: Machine Learning Approach}
\begin{itemize}
\item Done literature survey on health (\textit{Prakruti}) analysis based on various subject data, viz. radial artery pulse signals (\textit{Naadi}), voice samples, face and tongue images.
\item Provided technical specifications and rules for data quality for creating database with voice and image samples. 
\item Implemented MATLAB and Python scripts for signal conditioning and feature extractions modules for voice and pulse signals data.
\item Wrote Python scripts for different supervised and unsupervised machine learning algorithms with scikit-learn library for data classification.
